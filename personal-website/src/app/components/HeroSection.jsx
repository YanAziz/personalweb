    ...
    <section>
      <div className="grid grid-cols-1 sm:grid-cols-12">
        <div className="col-span-7 place-self-center text-center sm:text-left">
          ...
          <div>
            <button className="px-6 py-3 rounded-full w-full sm:w-fit mr-4 text-white bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 hover:bg-slate-200">Hire Me</button>
            <button className="px-1 py-1 rounded-full w-full sm:w-fit text-white bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 hover:bg-slate-800 mt-3">
